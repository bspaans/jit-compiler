...
func encode_IR_Equals(i *expr.IR_Equals, ctx *IR_Context, target encoding.Operand, includeSETE bool) ([]lib.Instruction, error) {
	...
	if includeSETE {
		...
		// TODO xor tmpreg
		sete := x86_64.SETE(tmpReg.Get8BitRegister())
